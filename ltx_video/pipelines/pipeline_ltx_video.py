...
class LTXVideoPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # conditioning_items[media_item] shape: (1, 3, 1, 480, 704) (b, c, f, h, w)
        ...
        # (1,2310, 128) pixel(1,3,2310) mask(1, 2310)  num_cond_latents=0
    ...
    def prepare_conditioning(
        ...
        if conditioning_items:
            ...
            for conditioning_item in conditioning_items:
                ...
                # (1, 128, 1, 15, 22) for image 704x480
                latents = vae_encode(
        ...
        # print("init_latent_coords", init_latent_coords)
        # (1, 3, 2310)
