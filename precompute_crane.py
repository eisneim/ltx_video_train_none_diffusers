...
if __name__ == "__main__":
    ...
    video_dir = [
        "/media/eisneim/teli-disk/ltx_train_data/reversed/game_crane_up",
    ]
    # cache_dir = "/media/eisneim/4T/ltx_0.9.5/49x1280x704/game_dolly_in"
    cache_dir = "/media/eisneim/4T/ltx_0.9.5/145x672x384/game_crane_down"
    ...
    prompt_prefix = "freeze time, camera crane down,"
    # ------------------- 
