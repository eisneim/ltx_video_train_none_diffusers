...
if __name__ == "__main__":
    ...
    video_dir = [
        # "/media/eisneim/teli-disk/ltx_train_data/game_dolly",
        "/media/eisneim/teli-disk/ltx_train_data/reversed/game_dolly",
    ]
    # cache_dir = "/media/eisneim/4T/ltx_0.9.5/49x1280x704/game_dolly_in"
    cache_dir = "/media/eisneim/4T/ltx_0.9.5/81x960x544/game_dolly_out"
    # cache_dir = "/media/eisneim/4T/ltx_0.9.5/57x704x1056/game_dolly_in"
    ...
    prompt_prefix = "freeze time, camera dolly out,"
    # ------------------- 
